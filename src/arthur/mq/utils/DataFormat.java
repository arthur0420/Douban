...
public class DataFormat {
	...
	public static Object getObjectByByteArray(byte[] m,int start,int length) throws Exception{
		ObjectInputStream ois = new ObjectInputStream(new ByteArrayInputStream(m,start,length));
		Object readObject = ois.readObject();
		return readObject;
	}
